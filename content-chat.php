<?php
/**
 * The template for displaying posts using the Chat post format
 *
 * @package WordPress
 * @subpackage Guts
 * @since Guts 0.0.1
...
<?php if ( !is_single() ) : // Not displayed on post pages using single.php ?>
 <header class="entry-header">
	<h2 class="entry-title">
		<a href="<?php the_permalink(); ?>" rel="bookmark"><i class="dashicons dashicons-format-chat"></i> <?php the_title(); ?></a>
	</h2>
